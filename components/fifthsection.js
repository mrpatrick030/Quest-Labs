...
export default function FifthSection() {
    return (
       ...
       <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-8">
        ...
        <div className="mt-[5%]"><span className="p-[0.3cm] bg-[rgba(0,0,0,1)] rounded-md"><Link href="https://ayalab.xyz">Visit Forum</Link></span>  &nbsp; &nbsp; <span className="p-[0.3cm] bg-[rgba(0,0,0,1)] rounded-md"><Link href="https://thequestlabs.vercel.app/marketplace">Visit Marketplace</Link></span></div>
        </div>
       </div>
        </div>
    )

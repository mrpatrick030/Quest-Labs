...
export default function SixthSection() {
 ...
 return (
    <div className="p-[5%]">
        ...
        <div className="mt-[5%] text-center"><Link href="/staking"><div className="px-[0.5cm] py-[0.3cm] bg-[rgba(0,200,0,0.1)] rounded-md lg:text-[110%] md:text-[105%] proceedtostakingpagebutton">Proceed to Staking Page</div></Link></div>
    </div>
 )
}